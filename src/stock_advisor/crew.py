...
from crewai.memory.short_term import short_term_memory
...
class TrendingCompanyList(BaseModel):
    ...
    companies: List[TrendingCompany] = Field(description="List of compnanies trending in the news")
    
class TrendingCompanyResearch(BaseModel):
    """ Detailed research in a company"""
    name: str = Field(description="Company name")
    market_position: str = Field(description="Current market position and competitive analysis")
    future_outlook: str = Field(description="Future outlook and growth prospects")
    investment_potential: str = Field(description="Invest potential and suitability for investment")

class TrendingCompanyResearchList(BaseModel):
    """ A list of detailed research on all the companies"""
    companies: List[TrendingCompanyResearch] = Field(description="Comprehensive research on all trending compnanies")

@CrewBase
class StockAdvisor():
    """Multi-agent stock research & recommendation crew"""

    agents_config = 'config/agents.yaml'
    tasks_config = 'config/tasks.yaml'

    # ---- Agents (must match agents.yaml keys) ----
    ...
    def crew(self) -> Crew:
        ...
        # Create portfolio manager ONLY inside crew()
        manager = Agent(
